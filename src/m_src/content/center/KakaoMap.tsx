...
const addLegend = (map: any) => {
  ...
  legendContent.innerHTML = `
    <div style="position:absolute;bottom:30px;left:10px;z-index:4;background:white;padding:10px;border-radius:5px;box-shadow:0 0 5px rgba(0,0,0,0.2);width:250px;">
